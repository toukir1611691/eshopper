...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<form class="form-horizontal" name="edit_product" action="<?php echo base_url();?>product/update_product" method="post" enctype="multipart/form-data">
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="text" name="product_name" value="<?php echo $product_data->product_name; ?>" >
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="text" name="product_short_desc" value="<?php echo $product_data->product_short_desc; ?>" >
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<select id="selectError3" name="product_category" value="<?php echo $product_data->product_category; ?>" >
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="text" name="product_price" value="<?php echo $product_data->product_price; ?>" >
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="text" name="product_quantity" value="<?php echo $product_data->product_quantity; ?>" >
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="file" name="product_image" class="input-file uniform_on" id="fileInput">
					<input type="hidden" name="product_old_image" value="<?php echo $product_data->product_image;?>" class="input-file uniform_on" id="fileInput">
					<img src="<?php echo base_url().$product_data->product_image?>" width="50" height="50">
				...
				<div class="control-group">
					...
					<div class="controls">
					<input type="checkbox" name="top_product" <?php if($product_data->top_product == 1) echo 'checked'; ?>" >
...
<script>
	document.forms['edit_product'].elements['product_category'].value=<?php echo $product_data->product_category ; ?>
</script>
