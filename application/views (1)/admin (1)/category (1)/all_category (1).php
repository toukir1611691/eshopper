				...
				<tr>
						...
						<td class="center ">
							<?php if($category->category_status == 1) {?>
								<a class="btn btn-success" href="<?php echo base_url("change-category-status/$category->category_id/0");?>" title="Update Status">
							...
							<a class="btn btn-danger" href="<?php echo base_url("delete-category/$category->category_id");?>" title="Delete">
