					...
					<form class="form-horizontal" action="<?php echo base_url();?>category/save_category" method="post">
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="category_name" value="" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" name="category_short_desc" value="" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea name="category_long_desc" class="cleditor" id="textarea2" rows="3"></textarea>
							  </div>
							</div>

							<div class="control-group hidden-phone">
								<label class="control-label" for="textarea2">Category Status</label>
								<div class="controls">
