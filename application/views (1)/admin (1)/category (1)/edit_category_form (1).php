...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <form class="form-horizontal" action="<?php echo base_url();?>category/update_category" method="post">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="category_name" value="<?php echo $category_data->category_name; ?>">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="category_short_desc" value="<?php echo $category_data->category_short_desc; ?>">
                ...
                <div class="control-group hidden-phone">
                    ...
                    <div class="controls">
                    <textarea name="category_long_desc" class="cleditor" id="textarea2" rows="3"> <?php echo $category_data->category_short_desc; ?> </textarea>
                    </div>
                </div>
