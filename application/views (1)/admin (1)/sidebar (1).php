<div id="sidebar-left" class="span2">
	<div class="nav-collapse sidebar-nav">
		<ul class="nav nav-tabs nav-stacked main-menu">
			...
			<li><a href="<?php echo base_url();?>all-category"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Category </span></a></li>
			<li><a href="<?php echo base_url();?>add-product"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Product </span></a></li>
			<li><a href="<?php echo base_url();?>all-product"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Product</span></a></li>
			<!--<li>
